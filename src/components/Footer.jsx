  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-4 text-white/70 font-medium">
              {['الرئيسية', 'عن Micro Masr', 'الأسئلة الشائعة', 'تواصل معنا'].map((link) => (
                <li key={link}>
                  <a href="#" className="hover:text-white hover:mr-1 transition-all duration-300 inline-block">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={index} className="flex items-center gap-4 text-white/80 group cursor-default">
        ...
        <div className="border-t border-white/10 pt-10 mt-16 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-base text-white/40">
            {['سياسة الخصوصية', 'الشروط والأحكام', 'سياسة الكوكيز'].map((legal) => (
