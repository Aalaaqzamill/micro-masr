...
const faqs = [
  ...
  {
    question: "إزاي أقدر أنشر رحلتي كسائق؟",
  ...
  },
  {
    ...
    answer: "لا يوجد أي مصاريف خفية! السعر اللي بتشوفه في تفاصيل الرحلة هو السعر النهائي اللي بتدفعه للسائق في بداية الرحلة."
  },
  {
    question: "إيه اللي بيحصل لو السائق لغى الرحلة؟",
    answer: "في حالة إلغاء الرحلة من قِبل السائق لظرف طارئ، بيتم إرسال إشعار فوري ليك على حسابك، وبتقدر تحجز رحلة بديلة في نفس الوقت بسهولة من خلال قائمة الرحلات."
  }
];
