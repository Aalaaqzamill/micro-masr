...
export function CTASection() {
  return (
    ...
    <section className="py-24 bg-[#4a7554] relative overflow-hidden" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <motion.div 
          ...
          className="w-24 h-24 bg-white/10 rounded-full flex items-center justify-center mb-10 mx-auto border border-white/5"
        >
          <Smartphone className="text-white/80" size={44} strokeWidth={1.5} />
        </motion.div>
        ...
        <motion.h2 
          ...
          className="text-white mb-6 text-4xl md:text-5xl font-bold tracking-tight"
        >
          جاهز تبدأ مشوارك؟
        </motion.h2>
        ...
        <motion.p 
          ...
          className="text-white/90 text-xl mb-12 max-w-3xl mx-auto leading-relaxed font-medium"
        >
