      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex bg-white p-1 rounded-2xl shadow-sm mb-8 overflow-hidden">
          <button
            ...
            className={`flex-1 py-3 text-center transition-all font-bold text-sm sm:text-base ${activeTab === 'requests'
          ...
          <button
            ...
            className={`flex-1 py-3 text-center transition-all font-bold text-sm sm:text-base ${activeTab === 'trips'
              ? 'bg-[#4A7554] text-white rounded-xl shadow-md'
              : 'text-gray-600 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-3 text-center transition-all font-bold text-sm sm:text-base ${activeTab === 'profile'
              ? 'bg-[#4A7554] text-white rounded-xl shadow-md'
              : 'text-gray-600 hover:bg-gray-50'
              }`}
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all font-bold text-gray-800 ${isEditingProfile
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      dir="ltr"
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all font-bold text-gray-800 text-right ${isEditingProfile
                        ? 'border-[#E5DBC8] focus:border-[#4A7554] bg-white'
                        : 'border-transparent bg-gray-50'
                        }`}
                    />
