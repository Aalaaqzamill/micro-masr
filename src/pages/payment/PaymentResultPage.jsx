...
export function PaymentResultPage() {
    ...
    return (
        <div
            className="min-h-screen bg-[#F2EEE3] flex items-center justify-center px-4 py-12"
            dir="rtl"
        >
                    ...
                    <div className="bg-white rounded-[2rem] shadow-2xl p-8 sm:p-12 text-center border-4 border-green-500 animate-[fadeIn_0.5s_ease-out]">
                        ...
                        <div className="mb-8 flex justify-center">
                            <button
                                onClick={() =>
                                    window.open(
                                        `https://www.google.com/maps?q=${tripDetails?.to || "Egypt"}`,
                                        "_blank"
                                    )
                                }
                                className="w-full px-6 py-4 border-2 border-[#4A7554] text-[#4A7554] rounded-xl bg-transparent hover:bg-[#4A7554] hover:text-white transition-all flex items-center justify-center gap-2 font-bold"
                            >
                                <MapPinned size={20} />
                                تابع رحلتك
                            </button>
                    ...
                    <div className="bg-white rounded-[2rem] shadow-2xl p-8 sm:p-12 text-center border-4 border-red-500 animate-[fadeIn_0.5s_ease-out]">
                        ...
                        <div className="bg-[#F2EEE3] rounded-xl p-5 mb-8 text-right">
                            <p className="text-sm text-gray-700">
                                ...
                                <a
                                    href="tel:19944"
                                    className="text-[#4A7554] font-bold hover:underline"
                                >
                                    19944
                                </a>
                            </p>
